...
//5 output port a tutti i server.Anche server 5
...
init{
	...
	global.iD_Server = 5; //ID del server, ogni server ha un ID diverso
	...
	startServer@ToServer5(t)  //Richiamo l'operazione startServer che mi fa partire il processo del server (loop infinito).
}
